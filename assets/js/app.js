...
$(document).ready(function () {
  ...
  if (pathURL == "/") {
    ...
    // Send data
    const scriptURL =
      "https://script.google.com/macros/s/AKfycbwwReEPH6Uaf6v_4ZPeGUva57jx7I66_yk26mByAYy3SXB-wfRyAvqCzgVwlkDQmHzu4A/exec";
    ...
    form.addEventListener("submit", (e) => {
      ...
      $("#submit-btn").html(
        '<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true" style="color: darkgray;"></span>'
      );
      e.preventDefault();
      fetch(scriptURL, { method: "POST", body: new FormData(form) })
        .then(function (response) {
          ...
          window.location.href =
            "/info/?uuid=" + document.getElementById("uuid").value;
    ...
    $(".qr-img").attr(
      "src",
      "https://api.qrserver.com/v1/create-qr-code/?size=150x150&bgcolor=eee&data=https://frwaniya.pages.dev/info?uuid=" +
        uuidd
    );
